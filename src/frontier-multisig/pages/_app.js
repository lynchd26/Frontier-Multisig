...
function MyApp({ Component, pageProps }) {
  return (
    <div>
        ...
        <aside id="default-sidebar" className="fixed top-0 left-0 z-40 w-1/6 h-screen transition-transform -translate-x-full sm:translate-x-0 align" aria-label="Sidebar">
